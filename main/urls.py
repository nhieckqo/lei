...
urlpatterns = [
    ...
    path('legislative_info/create',views.LegislativeInfoCreateView.as_view(),name='details_add'),
    path('legislative_info/<int:pk>', views.LegislativeInfoUpdateView.as_view(), name='details_edit'),
    path('legislative_info/<int:pk>/delete',views.LegislativeInfoDeleteView.as_view(),name="details_delete"),
]
